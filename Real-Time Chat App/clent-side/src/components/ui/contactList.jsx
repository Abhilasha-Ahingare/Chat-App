...
const ContactList = ({ contacts, isChannel = false }) => {
  ...
  const handleClick = (contacts) => {
    ...
    // No-op: MobileChatLayout will handle showing chat area
  };
            ...
            <div className="flex gap-3 items-center text-neutral-300 p-4 m-4">
              {!isChannel && (
                <div className="relative flex items-center justify-center">
                  {" "}
                  {/* Cleaned up extra margin/padding */}
              ...
              <div className="flex flex-col">
                {isChannel ? (
                  ...
                  <>
                    <span className="font-medium text-white group-hover:text-white/90 transition-colors">{`${constants.firstName} ${constants.lastName}`}</span>
